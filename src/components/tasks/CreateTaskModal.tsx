  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <span className="rounded-md px-3 py-2 text-sm font-medium text-black hover:bg-white/5">
          New Task
        </span>
      </DialogTrigger>
      <DialogContent>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="flex flex-col gap-6 mb-6">
            <div className="grid gap-2 relative">
              ...
              <Input
                id="title"
                placeholder={t("task_modal.task_name_placeholder")}
              />
            </div>
          </div>
          <div className="flex flex-col gap-6 mb-6">
        ...
        <DialogFooter>
          ...
          <DialogClose>
            <Button type="submit">
              {t("task_modal.submit_button_create")}
            </Button>
          </DialogClose>
        </DialogFooter>
      </DialogContent>
